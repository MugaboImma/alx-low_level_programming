...
/**
 * strtow -  function thta splits a string into words.
 * @str: the string
 *
...
/**
 * util - an util function for fetching words into an array
 * @words: the string's array
 * @str: the string
 */
